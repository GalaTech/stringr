...
#import "StringrTestViewController.h"
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        StringrTestViewController *homeViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"TestController"];
        navigationController.viewControllers = @[homeViewController];
    } else {
        StringrTestViewController *secondViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"Test2Controller"];
