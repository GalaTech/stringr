...
@interface StringReorderableCollectionViewFlowLayout ()
...
@property (assign, nonatomic, readonly) id<StringReorderableCollectionViewFlowLayoutDataSource> dataSource;
@property (assign, nonatomic, readonly) id<StringReorderableCollectionViewFlowLayoutDelegate> delegate;

@end

@implementation StringReorderableCollectionViewFlowLayout
...
- (id<StringReorderableCollectionViewFlowLayoutDataSource>)dataSource {
    return (id<StringReorderableCollectionViewFlowLayoutDataSource>)self.collectionView.dataSource;
}

- (id<StringReorderableCollectionViewFlowLayoutDelegate>)delegate {
    return (id<StringReorderableCollectionViewFlowLayoutDelegate>)self.collectionView.delegate;
}
