...
@interface StringCollectionViewFlowLayout ()
{
...
@implementation StringCollectionViewFlowLayout
...
- (void)prepareLayout
{
    ...
    NSAssert([self.delegate conformsToProtocol:@protocol(StringCollectionViewFlowLayoutDelegate)], @"UICollectionView delegate should conform to BalancedFlowLayout protocol");
...
// Temporarily commented out to make this class work as a subclass of UICollectionViewFlowLayout rather
// than direcltly inherited from UICollectionViewLayout. 
/*
...
- (id<StringCollectionViewFlowLayoutDelegate>)delegate
{
    return (id<StringCollectionViewFlowLayoutDelegate>)self.collectionView.delegate;
}
...
- (CGSize)referenceSizeForHeaderInSection:(NSInteger)section
{
    ...
    if (respondsToSelector) {
        return [(id <StringCollectionViewFlowLayoutDelegate>)self.collectionView.delegate collectionView:self.collectionView layout:self referenceSizeForHeaderInSection:section];
    }
...
- (CGSize)referenceSizeForFooterInSection:(NSInteger)section
{
    ...
    if (respondsToSelector) {
        return [(id <StringCollectionViewFlowLayoutDelegate>)self.collectionView.delegate collectionView:self.collectionView layout:self referenceSizeForFooterInSection:section];
    }
