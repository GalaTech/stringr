...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // This is where you set the inset of the entire collection view
        flowLayout.sectionInset = UIEdgeInsetsMake(0, 100, 0, 0);
        
        //This is where you set the collection view cell width
